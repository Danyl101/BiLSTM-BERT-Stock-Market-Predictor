...
def scroll_and_scrape(driver, url, max_scrolls=10):#Function to scroll and scrape articles from a given URL
    ...
    for _ in range(max_scrolls): #Function to Scroll through page
        ...
        clean_articles(raw_articles) #Calls clean articles function to filter out unwanted sites
...
def clean_articles(raw_articles): #Function to clean articles and filter out unwanted sites
    ...
    write_to_json(cleaned_articles) #Calls write to json function to write articles to a json file
 
def write_to_json(cleaned_articles): #Function to write articles to a json file
